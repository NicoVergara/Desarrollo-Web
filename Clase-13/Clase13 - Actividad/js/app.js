...
*/
var personajes = $('.personajes li');
personajes.addClass('pod');

$('h1, h2').addClass('simpsons-font');

console.log(personajes);

$('.personajes').prepend('<li class="pod"><h2>Maggie</h2><img src="img/maggie.png"><p class="description">Margaret Evelyn "Maggie" Simpson es un personaje ficticio de la serie de televisión de dibujos animados Los Simpson. Es la tercera hija del matrimonio protagonista, Homer y Marge Simpson, y la más joven de ellos. Sus hermanos mayores son Bart y Lisa Simpson. Siempre se la ve succionando un chupete y cuando camina, suele tropezar con el mono y cae de frente.</p></li>');

var bart = $('.personajes li')[3];
var exbart = $(bart).remove();
$('.personajes').prepend(exbart);

$('.pod').click(function(event){
  $(this).fadeOut();
});
